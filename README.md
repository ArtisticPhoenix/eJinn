...
If you answered _Yes_ to any of the above then __eJinn__ may be just what you have been missing.  __eJinn__ builds excpetion classes and interfaces based on a simple and flexable configuration file _(Entities)_. __eJinn__ allows you to orginize all your exception files in an easy logically based, easy to read configuration.  
