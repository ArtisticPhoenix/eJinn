...
Internal properties are denoted with __private__ in the __Required__ column below.  In genral these properties are not accessable outside the _\\eJinn\\eJinnParser_ class and are shown here only for completeness and documentation purposes. They should **not** be included anywere within the configuration. 
